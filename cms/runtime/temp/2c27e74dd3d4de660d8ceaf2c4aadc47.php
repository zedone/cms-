                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('add'); ?>" method="post">
                            ...
                            <div class="col-sm-6">
								<select name="pid">
									<option value="0">顶级规则</option>
										<?php if(is_array($ruleRes) || $ruleRes instanceof \think\Collection || $ruleRes instanceof \think\Paginator): $i = 0; $__LIST__ = $ruleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Res): $mod = ($i % 2 );++$i;?>
									<option <?php if($child['id'] == $Res['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $Res['id']; ?>">	<?php echo str_repeat("-----|  ",$Res['level']);?><?php echo $Res['title']; ?></option>
										<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="name" <?php if($child['name']): ?> value="<?php echo $child['name'].'/'; ?>" <?php endif; ?>  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
						...
						<div class="form-group">
							...
							<label>
                                <input  checked="checked" name="status" value="1" type="radio"  class="colored-blue">
                                <span class="text"> 是</span>
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label>
                                <input  type="radio" name="status" value="0" class="colored-danger">
						...
						<div class="form-group">
							...
							<label>
								<input  checked="checked" name="show" value="1" type="radio"  class="colored-blue">
								<span class="text"> 是</span>
							</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label>
								<input  type="radio" name="show" value="0" class="colored-danger">
								<span class="text"> 否</span>
							</label>
						</div>
