<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\archives\list.htm";i:1543500923;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('cate/lst'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                           <?php if(is_array($lstRes) || $lstRes instanceof \think\Collection || $lstRes instanceof \think\Paginator): $i = 0; $__LIST__ = $lstRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lst): $mod = ($i % 2 );++$i;?>
                            <tr fid="tr_    ">
                                ...
                                <td align="left"><?php echo $lst['title']; ?></td>
                                <td align="center"><?php echo $lst['attr']; ?></td>
                                <td align="center"><?php echo $lst['catename']; ?></td>
                                <!-- 1文本输入，2单选，3多选，4下拉菜单，5文本域，6附件 7浮点，8整型，9长文本 -->
                                <td align="center"><?php echo $lst['model_name']; ?></td>

                                <td align="center">
                                    <a href="<?php echo url('edit',['id'=>$lst['id'],'model_id'=>$lst['model_id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#"   onclick="ajaxdel(this)" class="btn btn-danger btn-sm shiny">
