<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\auth_group\lst.htm";i:1553349318;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div  class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="row">
							<?php if(is_array($lst) || $lst instanceof \think\Collection || $lst instanceof \think\Paginator): $i = 0; $__LIST__ = $lst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Res): $mod = ($i % 2 );++$i;?>
                            <tr id="tr_<?php echo $Res['id']; ?>">
								...
								<td align="center">
									...
									<label>
                                        <input class="checkbox-slider slider-icon colored-blue" <?php if($Res['status'] == 1): ?> checked="checked" <?php endif; ?> changeid="<?php echo $Res['id']; ?>" Static="<?php echo $Res['status']; ?>" onclick="changeStatic(this)"  type="checkbox">
                                        <span class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开启</span>
                                    </label>

								</td>
                                <td  align="center">
									<a href="<?php echo url('power',['id'=>$Res['id']]); ?>"  class="btn btn-warning shiny"><i class="fa fa-sun-o"></i>分配权限</a>

                                    <a href="<?php echo url('edit',['id'=>$Res['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>

                                    <a adminid="<?php echo $Res['id']; ?>" onclick="ajaxdel(this);" class="btn btn-danger btn-sm shiny">
	...
	function ajaxdel(o){
		layer.confirm('确认删除该用户组吗?', {icon: 3, title:'提示'}, function(index){
