<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\note\list.htm";i:1543922150;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('addListRules'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">采集节点名称</th>
                                <th class="text-center">所属模型</th>
                                <th class="text-center">添加时间</th>
                                <th class="text-center">最后采集时间</th>
                                <th class="text-center" width="10%">列表采集规则</th>
                                <th class="text-center">内容页采集规则</th>
                                <th class="text-center" width="18%">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($noteRes) || $noteRes instanceof \think\Collection || $noteRes instanceof \think\Paginator): $i = 0; $__LIST__ = $noteRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$note): $mod = ($i % 2 );++$i;?>
                            <tr mid="tr_<?php echo $note['id']; ?>">
                                <td align="center"><?php echo $note['id']; ?></td>
                                <td align="center"><?php echo $note['note_name']; ?></td>
                                <td align="center"><?php echo $note['model_name']; ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i:s",$note['addtime'] ); ?></td>
                                <td align="center">
                                    <?php if($note['lasttime'] != '0'): ?>
                                        <?php echo date("Y-m-d H:i:s",$note['lasttime'] ); else: ?>
                                        从未采集
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <a href="<?php echo url('Note/docaiji',array('id'=>$note['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-plus"></i> 采集
                                    </a>
                                    <a href="<?php echo url('edit',array('id'=>$note['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" modelid="<?php echo $note['id']; ?>" onclick="ajaxdel(this)" class="btn btn-danger btn-sm shiny">
