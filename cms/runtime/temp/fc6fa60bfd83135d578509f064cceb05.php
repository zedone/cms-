<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\admin\add.htm";i:1553252611;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                            ...
                            <div class="col-sm-6">
                                <select name="groupid">
									...
									<?php if(is_array($group) || $group instanceof \think\Collection || $group instanceof \think\Paginator): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lst): $mod = ($i % 2 );++$i;?>
										<option value="<?php echo $lst['id']; ?>"><?php echo $lst['title']; ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
                            </div>
