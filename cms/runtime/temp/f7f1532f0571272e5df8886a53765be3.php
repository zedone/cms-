<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/install\view\index\step2.htm";i:1553955395;}*/ ?>
﻿<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库服务器</label>
          <span>
          <input type="text" name="db_host" maxlength="60" value="localhost">
          </span> <em>数据库服务器地址，一般为localhost</em></div>
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="50" value="">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
          <input type="text" name="db_user" maxlength="30" value="">
          </span> <em></em></div>
        <div>
          <label>数据库密码</label>
          <span>
          <input type="password" name="db_pwd" maxlength="30" value="">
          </span> <em></em></div>
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db_prefix" maxlength="30" value="tp_">
          </span> <em>同一数据库运行多个多用户商城程序时，请修改前缀</em></div>
        <div>
          <label>数据库端口</label>
          <span>
          <input type="text" name="db_port" maxlength="30" value="3306">
          </span> <em>数据库默认端口一般为3306</em></div>
                <div>
          <label>&nbsp;</label>
          <input name="demo_data" type="checkbox" id="demo_data" value="1" checked checked>
      ...
      <fieldset>
        ...
        <div>
          <label>管理员帐号</label>
          <span>
          <input name="admin" value="" maxlength="20" type="text">
          </span> <em></em></div>
        <div>
          <label>管理员密码</label>
          <span>
        ...
        <div>
          <label>重复密码</label>
          <span>
          <input name="rpassword" value="" maxlength="20" type="password">
          </span> <em>确保两次输入的密码一致</em></div>
      </fieldset>
    </div>
    <div class="btn-box"><a href="/cms/public/static/install/step1.htm" class="btn btn-primary">上一步</a><a id="next"  class="btn btn-primary">下一步</a></div>
  </form>
</div>
<div class="footer">
