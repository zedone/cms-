<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\auth_group\power.htm";i:1553251723;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('power'); ?>" method="post">
						<input type="hidden" name="id" value="<?php echo $pow['id']; ?>" />
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">用户组名：</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $pow['title']; ?>" name="title"  disabled="disabled" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label>
								<table class="table table-hover">
                                    ...
                                    <tbody>
										<!-- 顶级权限 -->
										<?php if(is_array($auth) || $auth instanceof \think\Collection || $auth instanceof \think\Paginator): if( count($auth)==0 ) : echo "" ;else: foreach($auth as $key=>$v0): ?>
                                        <tr>
                                            <td>
												<label>
                                                    <input id="<?php echo $v0['id']; ?>" value="<?php echo $v0['id']; ?>" dataid="id-<?php echo $v0['id']; ?>" name="rules[]" type="checkbox" class="colored-danger checkbox-parent" <?php if(in_array($v0['id'],$rule)): ?> checked="checked" <?php endif; ?>>
                                                    <span class="text"><?php echo $v0['title']; ?></span>
                                                </label>
											</td>
                                        </tr>
											...
											<?php if($v0['children']): ?>
												...
												<?php if(is_array($v0['children']) || $v0['children'] instanceof \think\Collection || $v0['children'] instanceof \think\Paginator): if( count($v0['children'])==0 ) : echo "" ;else: foreach($v0['children'] as $key=>$v1): ?>
												<tr>
													<td style="padding-left:40px;">
														<label>
                                                            <input id="<?php echo $v1['id']; ?>" value="<?php echo $v1['id']; ?>"  name="rules[]" dataid="id-<?php echo $v0['id']; ?>-<?php echo $v1['id']; ?>" type="checkbox" class="colored-blue checkbox-parent checkbox-child" <?php if(in_array($v1['id'],$rule)): ?> checked="checked" <?php endif; ?>>
                                                            <span class="text"><?php echo $v1['title']; ?></span>
                                                        </label>
													</td>
												</tr>
													...
													<tr>
														<td style="padding-left:80px;">
															<?php if(is_array($v1['children']) || $v1['children'] instanceof \think\Collection || $v1['children'] instanceof \think\Paginator): if( count($v1['children'])==0 ) : echo "" ;else: foreach($v1['children'] as $key=>$v2): ?>
																<label style="padding-left:20px;">
		                                                            <input id="<?php echo $v2['id']; ?>"  name="rules[]" value="<?php echo $v2['id']; ?>" dataid="id-<?php echo $v0['id']; ?>-<?php echo $v1['id']; ?>-<?php echo $v2['id']; ?>" type="checkbox" class="colored-warning checkbox-child" <?php if(in_array($v2['id'],$rule)): ?> checked="checked" <?php endif; ?>>
		                                                            <span class="text"><?php echo $v2['title']; ?></span>
		                                                        </label>
															<?php endforeach; endif; else: echo "" ;endif; ?>
														</td>
													</tr>
